...
//--------2
function showUserInfo_base(user) {
    // 省略
}
// 使用例
showUserInfo_base({
...
// };
//--------3
const isPositive_base2 = num => num >= 0;
// 使用例
isPositive_base2(5);
// エラー例
...
// 使用例
const sum = sumOfPos_base([1, 3, -2, 0]);
// エラー例
...
// 使用例
const obj1 = giveId_base({ foo: 123 });
const obj2 = giveId_base({
    num: 0,
    hoge: true
});
// エラー例
...
// 型引数を明示することも可能
const [anotherState_base, setAnotherState_base] = useState(null);
setAnotherState(100);
// エラー例
...
//# sourceMappingURL=practice_base.js.map